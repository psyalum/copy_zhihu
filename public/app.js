...
router.post('/getdetail', function (req, res) {
    ...
    connection.connect();
    connection.query("SELECT * FROM db_zhihu.db_zhihu_answ " +
        "join db_zhihu.db_zhihu_user on db_zhihu_user_id=db_zhihu_answ_author " +
        "join db_zhihu.db_zhihu_ques on db_zhihu_ques_id=db_zhihu_answ_ques "+
